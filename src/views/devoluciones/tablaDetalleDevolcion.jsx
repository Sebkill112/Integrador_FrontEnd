...
function TablaDetalleDevolucion(props) {
    ...
    const eliminarDocumento = (id) => {
        Swal.fire({
            title: '¡Alerta!',
            text: '¿Esta seguro de eliminar el libro de tu devolucion?',
            type: 'warning',
                            ...
                            (row, index) => (
                                <TableRow key={index + 1}>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.ejemplar}
                                    </TableCell>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.libro?.nombre}
                                    </TableCell>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.libro?.autor}
                                    </TableCell>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.libro?.genero?.nombre}
                                    </TableCell>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.libro?.edicion}
                                    </TableCell>
...
export default TablaDetalleDevolucion;