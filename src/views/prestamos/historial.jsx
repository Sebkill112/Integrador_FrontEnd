...
export default function Historial() {
    ...
    React.useEffect(() => {
        (async () => {
            const response = await http.get(`/api/prestamo/historial/${user.codigo}`); 
    ...
    return (
        <>
            ...
            <FullScreenDialog open={detalle} handleClose={handleCloseDetallePrestamo} title="Detalle del  Prestamo">
                <div
                    style={{
                        minWidth: 'calc(80vw)',
                        display: 'flex',
                ...
                >
                    <MainCard>
                       <DetalleHistorial dataPrestamo={prestamo} />
                    </MainCard>
                </div>
            </FullScreenDialog>
        </>
