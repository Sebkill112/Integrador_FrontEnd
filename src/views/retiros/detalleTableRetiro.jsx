...
function TablaDetalleRetiro(props) {
    const { propiedades, datahijo } = props;
    const theme = useTheme();
    ...
    const eliminarDocumento = (id) => {
        Swal.fire({
            title: '¡Alerta!',
            text: '¿Esta seguro de eliminar el libro de tu retiro?',
            type: 'warning',
                            ...
                            (row, index) => (
                                <TableRow key={index + 1}>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.libroEjemplar.codigo}
                                    </TableCell>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.libroEjemplar.nombre}
                                    </TableCell>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.libroEjemplar.autor}
                                    </TableCell>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.libroEjemplar.editorial.nombre}
                                    </TableCell>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.libroEjemplar.genero.nombre}
                                    </TableCell>
                                    <TableCell component="th" scope="row" style={{ textAlign: 'center' }}>
                                        {row.ejemplar.libroEjemplar.edicion}
                                    </TableCell>
...
export default TablaDetalleRetiro;